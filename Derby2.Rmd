---
title: Design of Fishing Derbies for use in Recreational Fisheries Management
author:
  - name: Trevor Davies
...
address:
  - code: FLNRORD
    address: B.C. Ministry of Forests, Lands and Natural Resource Operations and Rural Development, Fish and Aquatic Habitat Branch, Victoria, British Columbia, Canada
...
Collecting and synthesizing data that is aligned with fishery management goals is essential for the long term sustainability of fishery resources.  Data used to manage fisheries are derived from two principle sources: fishery-dependent data (scientific surveys) and fishery-independent data (collected from active participants in the fishery). The collection of fishery-independent data is preferred as it is less prone to bias and confounding effects that can arise from individual fisher behavior including skill and gear selection.  Although preferred, fishery-independent data are expensive to collect leaving fishery-dependent data as an attractive alternative.  Depending on the value of the fishery, the use of fishery-dependent data can have dire consequences.  Indeed, one of the causes of the worlds greatest fishery collapse (Atlantic cod) was a result of weighing commercial fishery catch-and-effort data in the analyses of population trends (see my thesis for reference for this).  There are however, ways to include fishery independent data and it plays a large role in the management of commercial fisheries (Tuna - see Maunder GLM paper).  This is possible for large scale fisheries where catches of individual vessels can be accounted for in the analysis but this is less practical for relatively small scale recreational fisheries.

New technologies are allowing for the easy and remote collection of recreational fishing data.  These data are collected by mobile apps where fishers opportunistically enter their catches and include other informataion such as size, species and even location.  These apps collect individual fishing behaviour so that can be controlled in the analysis but still suffer from gear and effort issues.
